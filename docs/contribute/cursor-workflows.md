...
**Script paths:** In documentation and prompts aimed at Claude Code, cross-skill scripts use `${CLAUDE_PLUGIN_ROOT}`. When you run or document commands for Cursor, use paths relative to the repository root (see [AGENTS.md](https://github.com/redhat-documentation/redhat-docs-agent-tools/blob/main/AGENTS.md)).
